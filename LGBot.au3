...
; Author ........:  (2014)
; Modified ......:
; Remarks .......: This file is part of Gabenk-like. Copyright 2015
;                  Gabenk-like is distributed under the terms of the GNU GPL
; Related .......:
; Link ..........:
; Example .......: No
; ===============================================================================================================================
...
#pragma compile(FileDescription, Clash of Clans Bot - https://www.Gabenk-like.ml)
#pragma compile(ProductName, LGBot COC )

#pragma compile(ProductVersion, 12.10)
#pragma compile(FileVersion, 12.10)
#pragma compile(LegalCopyright, © http://www.gabenk-like.ml)

$sBotVersion = "v.12 Lastest                                         "
$sBotTitle = "Leeyonk Gabenk - LGBot " & $sBotVersion
...
;check last version from www.Gabenk-like.ml site
IF $ichkVersion = 1 Then
	CheckVersionHTML()
	If $lastversion = "" Then
		SetLog("Cannot detect last version from www.Gabenk-like.ml", $COLOR_ORANGE)
	ElseIf $sBotVersion <> $lastversion  Then
		SetLog("WARNING, THIS VERSION (" & $sBotVersion & ") IT'S OUT OF DATE", $COLOR_RED)
		SetLog("PLEASE DOWNLOAD LATEST(" & $lastversion & ") from www.gabenk-like.ml               ", $COLOR_RED)
		If $lastmessage <> "" THEN SetLog(  $lastmessage , $COLOR_RED )
	Else
		SetLog("WELCOME, YOU HAVE LATEST VERSION (" & $sBotVersion & ") OF THE BOT", $COLOR_GREEN)
	EndIf
EndIf
