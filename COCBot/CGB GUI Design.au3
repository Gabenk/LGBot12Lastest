...
; Remarks .......: This file is part of www.Gabenk-like.ml Copyright 2015
;                  www.Gabenk-like.ml is distributed under the terms of the GNU GPL
; Related .......:
; Link ..........:
...
Local $x = 30, $y = 150
	$grpCredits = GUICtrlCreateGroup("Credits", $x - 20, $y - 20, 450, 375)
		$txtCredits = "LGBot is brought to you by a worldwide team of open source"  & @CRLF & _
						"programmers and a vibrant community of Gabenk members!"
		$lblCredits1 = GUICtrlCreateLabel($txtCredits, $x - 5, $y, 400, 50)
			GUICtrlSetFont(-1, 9, $FW_BOLD)
			GUICtrlSetColor(-1, $COLOR_NAVY)
		$y += 35
		$txtCredits = "Please visit our web:"
		$lblCredits2 = GUICtrlCreateLabel($txtCredits, $x - 5, $y, -1, -1)
		$y += 20
		$labelGameBotURL = GUICtrlCreateLabel("http://www.Gabenk-like.ml", $x - 5, $y, 150, 20)
		...
		$txtCredits =	"Antidote, AtoZ, Didipe, Dinobot, DixonHill, DkEd, Envyus, GkevinOD, Hervidero,"  & @CRLF & _
                        "HungLe, kaganus, KnowJack, ProMac, Safar46, Sardo, Saviart and Gabenk"  & @CRLF & _
						"" & @CRLF & _
						"And to all gabenk members contributing to make this great software!" & @CRLF & _
						"" & @CRLF & _
						"The latest release of the 'LGBot COC' can be found at:"
		$lbltxtCredits = GUICtrlCreateEdit($txtCredits, $x - 5, $y, 400, 80, BITOR($WS_VISIBLE, $ES_AUTOVSCROLL, $ES_READONLY, $SS_LEFT),0)
			GUICtrlSetBkColor(-1, $COLOR_WHITE)
		$y += 85
		$labelForumURL = GUICtrlCreateLabel("http://www.Gabenk-like.ml", $x - 5, $y, 450, 20)
			GUICtrlSetFont(-1, 8.5, $FW_BOLD)
			GUICtrlSetColor(-1, $COLOR_BLUE)
		$y += 100
		$txtWarn =	"By running this program, the user accepts all responsibility that arises from the use of this software."  & @CRLF & _
						...
						"Copyright (C) 2015 Gabenk-like.ml"
...
_GUICtrlStatusBar_SetText($statLog, "Status : Selamat Hari Raya Galungan & Kuningan dan Hari Raya Idul Fitri")
